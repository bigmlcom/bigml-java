Feature: Testing correlations REST api calls
    ...
    Scenario Outline: Successfully creating a correlation from a dataset:
        ...
        Examples:
        | data                |  seed  |  time_1  | time_2 | time_3 | time_4 | correlation_name |
        | data/iris.csv | BigML | 10      | 10     | 20     | 20 | my new correlation name |

Feature: Create Predictions
  ...
  Scenario Outline: Successfully comparing predictions:
    ...
    Examples:
      ...
      | data/iris.csv | BigML |   50      | 50     | 50     | {"petal width": 0.5}                   | 000004    | Iris-setosa |
      | data/iris.csv | BigML |   50      | 50     | 50     | {"petal length": 6, "petal width": 2}  | 000004    | Iris-virginica |
      | data/iris.csv | BigML |   50      | 50     | 50     | {"petal length": 4, "petal width": 1.5}| 000004    | Iris-versicolor |
      | data/iris_sp_chars.csv | BigML |  50      | 50     | 50     | {"pétal.length": 4, "pétal&width\u0000": 1.5}| 000004    | Iris-versicolor |
  ...
  Scenario Outline: Successfully comparing predictions with text options:
    ...
    Examples:
      ...
      #| data/text_missing.csv | BigML |    20      | 20     | 30     | {"fields": {"000001": {"optype": "text", "term_analysis": {"token_mode": "all", "language": "en"}}, "000000": {"optype": "text", "term_analysis": {"token_mode": "all", "language": "en"}}}} |{}       | 000003    | swap     |
  ...
  Scenario Outline: Successfully comparing predictions with proportional missing strategy:
    ...
    Examples:
      | data              | seed  | time_1  | time_2  | time_3  | data_input  | objective | prediction      | confidence        |
      | data/iris.csv     | BigML |   50    |   50    |   50    |   {}  |   000004  |   Iris-setosa   | 0.2629           |
  ...
  Scenario Outline: Successfully comparing predictions with proportional missing strategy:
    ...
    Examples:
      | data               | seed  | time_1  | time_2 | time_3 | data_input           | objective | prediction     | confidence |
      | data/grades.csv | BigML |   50      | 50     | 50     | {}                   | 000005    | 68.62224       | 27.5358    |
      | data/grades.csv | BigML |   50      | 50     | 50     | {"Midterm": 20}      | 000005    | 40.46667      | 54.89713   |
      | data/grades.csv | BigML |   50      | 50     | 50     | {"Midterm": 20, "Tutorial": 90, "TakeHome": 500}     | 000005    | 28.06      | 25.65806   |
  ...
  Scenario Outline: Successfully comparing predictions with proportional missing strategy for missing_splits models:
    ...
    Examples:
      | data               |  seed  | time_1  | time_2 | time_3 | data_input  | objective | prediction     | confidence |
      | data/iris_missing2.csv   | BigML |     50      | 50     | 50     | {"petal width": 1}             | 000004    | Iris-setosa    | 0.8064     |
      | data/iris_missing2.csv   | BigML |     50      | 50     | 50     | {"petal width": 1, "petal length": 4}             | 000004    | Iris-versicolor    | 0.7847     |

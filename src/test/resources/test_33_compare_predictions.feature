Feature: Compare predictions
    ...
    Scenario Outline: Successfully comparing centroids with or without text options:
        ...
        Examples:
          ...
          | data/spam.csv | BigML |    20      | 20     | 30     | {"fields": {"000001": {"optype": "text", "term_analysis": {"case_sensitive": true, "stem_words": true, "use_stopwords": false, "language": "en"}}}} |{"Type": "ham", "Message": "Mobile call"}             | Cluster 7   | 0.36637   |
          ...
          | data/spam.csv | BigML |    20      | 20     | 30     | {"fields": {"000001": {"optype": "text", "term_analysis": {"case_sensitive": false, "stem_words": true, "use_stopwords": true, "language": "en"}}}} |{"Type": "ham", "Message": "Mobile call"}               | Cluster 0      | 0.5   |
          | data/spam.csv | BigML |    20      | 20     | 30     | {"fields": {"000001": {"optype": "text", "term_analysis": {"case_sensitive": false, "stem_words": true, "use_stopwords": true, "language": "en"}}}} |{"Type": "ham", "Message": "A normal message"}       | Cluster 1    | 0.36637   |
          ...
          | data/spam.csv | BigML |    20      | 20     | 30     | {"fields": {"000001": {"optype": "text", "term_analysis": {"case_sensitive": true, "stem_words": true, "use_stopwords": false, "language": "en"}}}} |{"Type": "", "Message": ""}             | Cluster 1   | 0.5   |
          ...
          | data/movies.csv | BigML |    20      | 20     | 30     | {"fields": {"000007": {"optype": "items", "item_analysis": {"separator": "$"}}}} |{"gender": "Female", "age_range": "18-24", "genres": "Adventure$Action", "timestamp": 993906291, "occupation": "K-12 student", "zipcode": 59583, "rating": 3}       | Cluster 1    | 0.7294650227133437     |
    ...
    Scenario Outline: Successfully comparing centroids with configuration options:
        ...
        Examples:
          | data             | seed  | time_1  | time_2 | time_3 | options | data_input | centroid  | distance |
          | data/iris.csv | BigML |20      | 20     | 30     | {"summary_fields": ["sepal width"]} |{"petal length": 1, "petal width": 1, "sepal length": 1, "species": "Iris-setosa"}  | Cluster 2   | 1.16436   |
         # | data/iris.csv | BigML |20      | 20     | 30     | {"default_numeric_value": "zero"} |{"petal length": 1}  | Cluster 4   | 1.41215   |

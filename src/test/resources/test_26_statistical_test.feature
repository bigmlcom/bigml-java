Feature: Testing statiticaltests REST api calls
    ...
    Scenario Outline: Successfully creating a statiticaltest from a dataset:
        ...
        Examples:
        | data                |  seed  |  time_1  | time_2 | time_3 | time_4 | statisticaltest_name |
        | data/iris.csv | BigML | 10      | 10     | 20     | 20 | my new statisticaltest name |

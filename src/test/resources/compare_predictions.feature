Feature: Compare Predictions
    ...
    Scenario Outline: Successfully comparing predictions:
  	...
  	Scenario Outline: Successfully comparing predictions:
        ...
        | data/spam.csv | 20      | 20     | 30     | {"fields": {"000001": {"optype": "text"}}} | true     | {"tags": ["unitTest"], "fields": {"000001": {"term_analysis": {"language":"en", "token_mode": "tokens_only"}}}} |{"Message": "FREE for 1st week! No1 Nokia tone 4 ur mob every week just txt NOKIA to 87077 Get txting and tell ur mates. zed POBox 36504 W45WQ norm150p/tone 16+"}       | 000000    | spam     |

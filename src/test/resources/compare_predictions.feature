Feature: Create Predictions
  ...
  Scenario Outline: Successfully comparing centroids with or without text options:
    ...
    Examples:
      ...
      | data/spam.csv | BigML |    20      | 20     | 30     | {"fields": {"000001": {"optype": "text", "term_analysis": {"case_sensitive": false, "stem_words": true, "use_stopwords": true, "language": "en"}}}} |{"Type": "ham", "Message": "Mobile call"}               | Cluster 2      | 0.3933996418221948   |
      | data/spam.csv | BigML |    20      | 20     | 30     | {"fields": {"000001": {"optype": "text", "term_analysis": {"case_sensitive": false, "stem_words": true, "use_stopwords": true, "language": "en"}}}} |{"Type": "ham", "Message": "A normal message"}       | Cluster 5    | 0.3979379273840342   |
      ...
      | data/diabetes.csv | BigML |    20      | 20     | 30     | {"fields": {}} |{"pregnancies": 0, "plasma glucose": 118, "blood pressure": 84, "triceps skin thickness": 47, "insulin": 230, "bmi": 45.8, "diabetes pedigree": 0.551, "age": 31, "diabetes": "true"}       | Cluster 7    | 0.4606892984894916     |
      | data/iris_sp_chars.csv | BigML |    20      | 20     | 30     | {"fields": {}} |{"pétal.length":1, "pétal&width\u0000": 2, "sépal.length":1, "sépal&width": 2, "spécies": "Iris-setosa"}       | Cluster 0    | 0.870682622108004     |
  ...
  Scenario Outline: Successfully comparing centroids with summary fields:
    ...
    Examples:
      | data             | seed  | time_1  | time_2 | time_3 | options | data_input                            | centroid  | distance |
      | data/iris.csv | BigML |20      | 20     | 30     | {"summary_fields": ["sepal width"]} |{"petal length": 1, "petal width": 1, "sepal length": 1, "species": "Iris-setosa"}             | Cluster 3   | 0.7155571246307187   |

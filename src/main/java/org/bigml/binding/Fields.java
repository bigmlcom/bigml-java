...
public class Fields {
	 ...
	 *                              subset
	 */
	public Fields(JSONObject resourceOrField, List<String> missingTokens, String dataLocale, Object objectiveField,
			Boolean objectiveFieldPresent, List<Long> includeFields) {
		...
		if (resourceOrField.containsKey("resource")) {
			...
			if (missingTokens == null) {
				missingTokens = new ArrayList<String>(Arrays.asList(DEFAULT_MISSING_TOKENS));
			}
		}
	 ...
	 */
	protected void updateObjectiveField(Object objectiveField, Boolean objectiveFieldPresent, List<String> headers) {
	 ...
	 */
	public Map<String, Object> pair(JSONArray row, List<String> headers, Object objectiveField,

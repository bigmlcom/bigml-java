...
public class Centroid extends AbstractResource {
   ...
   *
   */
  public Centroid(final String apiUser, final String apiKey, final boolean devMode) {
   ...
   *
   */
  public JSONObject create(final String clusterId, JSONObject inputDataJSON, String args, Integer waitTime, Integer retries) {
  ...
  public JSONObject get(final String centroidId) {
    if (centroidId == null || centroidId.length() == 0 || !centroidId.matches(CENTROID_RE)) {
